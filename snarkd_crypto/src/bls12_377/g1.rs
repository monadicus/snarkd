...
impl Group for G1Parameters {
    ...
    /// WEIERSTRASS_A = 0
    const A: Fq = uint!(0_U384);

    /// WEIERSTRASS_B = 1
    const B: Fq = uint!(1_U384);
}
...
///
const G1_GENERATOR_X: Fq = uint!(89363714989903307245735717098563574705733591463163614225748337416674727625843187853442697973404985688481508350822_U384);
...
/// See `snarkvm_algorithms::hash_to_curve::tests::bls12_377` for tests.
///
const G1_GENERATOR_Y: Fq = uint!(3702177272937190650578065972808860481433820514072818216637796320125658674906330993856598323293086021583822603349_U384);
