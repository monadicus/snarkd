...
impl<'a, P: Fp6Parameters> MulAssign<&'a Self> for Fp6<P> {
    ...
    fn mul_assign(&mut self, other: &Self) {
        ...
        let c0 =
            P::mul_fp2_by_nonresidue(&((self.c1 + self.c2) * (other.c1 + other.c2) - v1 - v2)) + v0;
        let c1 =
            (self.c0 + self.c1) * (other.c0 + other.c1) - v0 - v1 + P::mul_fp2_by_nonresidue(&v2);
...
impl<P: Fp6Parameters> CanonicalSerializeWithFlags for Fp6<P> {
    ...
    fn serialized_size_with_flags<F: Flags>(&self) -> usize {
        self.c0.uncompressed_size()
            + self.c1.uncompressed_size()
...
impl<P: Fp6Parameters> CanonicalSerialize for Fp6<P> {
    ...
    fn serialized_size(&self, compress: Compress) -> usize {
        self.c0.serialized_size(compress)
            + self.c1.serialized_size(compress)
            + self.c2.serialized_size(compress)
    }
}
