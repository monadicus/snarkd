...
mod tests {
    ...
    use crate::{polycommit::test_templates::*, utils::PoseidonSponge};
    use rand::distributions::Distribution;

    type Sponge = PoseidonSponge;
    type PC_Bls12_377 = SonicKZG10;
    ...
    fn test_quadratic_poly_degree_bound_multiple_queries() {
        quadratic_poly_degree_bound_multiple_queries_test();
    }
    ...
    fn test_single_poly_degree_bound_multiple_queries() {
        single_poly_degree_bound_multiple_queries_test();
    }

    #[test]
    fn test_two_polys_degree_bound_single_query() {
        two_polys_degree_bound_single_query_test();
    }
    ...
    fn test_two_equation_degree_bound() {
        two_equation_degree_bound_test();
    }

    #[test]
    fn test_full_end_to_end_equation() {
        full_end_to_end_equation_test();
    }
