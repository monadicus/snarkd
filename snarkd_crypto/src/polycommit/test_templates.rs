...
pub fn bad_degree_bound_test() -> Result<(), PCError> {
    ...
    let max_degree = 100;
    let pp = SonicKZG10::load_srs(max_degree).unwrap();
...
fn test_template(info: TestInfo) {
    let TestInfo {
        num_iters,
        max_degree,
        supported_degree,
...
fn equation_test_template(info: TestInfo) {
    let TestInfo {
        num_iters,
        max_degree,
        supported_degree,
...
pub fn linear_poly_degree_bound_test() {
    let info = TestInfo {
        num_iters: 100,
        max_degree: Some(2),
...
pub fn single_poly_degree_bound_test() {
    let info = TestInfo {
        num_iters: 100,
        max_degree: None,
        supported_degree: None,
...
pub fn quadratic_poly_degree_bound_multiple_queries_test() {
    let info = TestInfo {
        num_iters: 100,
        max_degree: Some(3),
...
pub fn single_poly_degree_bound_multiple_queries_test() {
    let info = TestInfo {
        num_iters: 100,
        max_degree: None,
        supported_degree: None,
...
pub fn two_polys_degree_bound_single_query_test() {
    let info = TestInfo {
        num_iters: 100,
        max_degree: None,
        supported_degree: None,
...
pub fn full_end_to_end_equation_test() {
    let info = TestInfo {
        num_iters: 100,
        max_degree: None,
        supported_degree: None,
...
pub fn two_equation_degree_bound_test() {
    let info = TestInfo {
        num_iters: 100,
        max_degree: None,
        supported_degree: None,
